  ...
  useEffect(() => {
    const fetchData = async () => {
      if (
        fetchedData &&
        fetchedData.data &&
        fetchedData.data.data.landing_product
      ) {
        setContent(
          fetchedData.data.data.landing_product.active_ingredient || ""
        );
      }
    };
...
<p>
  ...
  return (
    <div className="add-product" id="add-product">
      <SectionTitle startText={"Антицелюлітна олія"} boldText={"Грейпфрут"} />
      <section className="add-product__content">
        ...
        <div className="content__text">
          <h3 className="content__text-subtitle">Активні Інгредієнти</h3>
          <div
